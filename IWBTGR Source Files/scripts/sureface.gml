...
show_error("The game failed to allocate a drawing surface of dimensions "+string(argument[1])+"x"+string(argument[2])+
             ".##Make sure you have enough vram available.##The game will now close.",1)
